...
# Test file upload
upload_url = "http://localhost:4200/api/knowledge/upload/file"
files_url = "http://localhost:4200/api/knowledge/upload/files"
...
print("\n=== Test completed ===")
print("You can check the import tasks at: http://localhost:4200/tasks")
